...
})(["width:80%;margin:0 auto;background:white;border:2px whitesmoke solid;padding:20px;position:relative;top:-60px;border-radius:25px;"]);
var Flex = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "Archive__Flex",
...
function Archive() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Projects, {
    ...
    __self: this
  }, "Projects"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Flex, {
    className: "row",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
...
//# sourceMappingURL=about.js.6323625ef239e664d55f.hot-update.js.map