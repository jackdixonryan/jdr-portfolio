...
})(["width:80%;max-width:750px;margin:0 auto;background:white;border:2px teal solid;padding:20px;position:relative;top:-60px;border-radius:25px;h3{font-family:\"Poiret One\",sans-serif;text-align:center;}#grid{display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr;grid-template-areas:\"linkedin email email\";justify-items:center;align-items:center;.linkedin{grid-area:linkedin;}.github{grid-area:github;}.email{grid-area:email;}}"]);
function Contact() {
...
//# sourceMappingURL=index.js.67f1358e94649eb1b1d6.hot-update.js.map