...
})(["@keyframes aurora{0%{background-position:left top;}25%{background-position:right top;}50%{background-position:right bottom;}75%{background-position:left bottom;}100%{background-position:left top;}}.outer{background:linear-gradient(45deg,#32a6ff 0%,#3f6fff 49%,#8d54ff 82%);background-size:200%;animation:aurora 10s infinite;}.inner{background:radial-gradient();background-size:200%;animation:aurora 7s infinite}"]);
...
//# sourceMappingURL=about.js.441d4991f50111ac1de2.hot-update.js.map