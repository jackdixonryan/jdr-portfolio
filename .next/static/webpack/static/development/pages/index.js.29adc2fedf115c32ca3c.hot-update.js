...
})(["width:80%;max-width:750px;margin:0 auto;background:white;border:2px teal solid;padding:20px;position:relative;top:-60px;border-radius:25px;h3{font-family:\"Poiret One\",sans-serif;text-align:center;}#grid{display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr;grid-template-areas:\"linkedin email github\";justify-items:center;align-items:center;.linkedin{grid-area:linkedin;}.github{grid-area:github;}.email{grid-area:email;}i{margin-right:6px;}}"]);
function Contact() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Main, {
    ...
    className: "fab fa-linkedin hide-on-small-and-down",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46
    },
    ...
    className: "fab fa-github hide-on-med-and-down",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53
    },
...
//# sourceMappingURL=index.js.29adc2fedf115c32ca3c.hot-update.js.map