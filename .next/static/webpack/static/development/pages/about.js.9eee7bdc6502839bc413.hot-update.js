...
})(["border-radius:50%;grid-area:north-planet;height:3em;width:3em;position:relative;bottom:45px;cursor:pointer;background-image:url(\"../static/images/planet.png\");background-position:center;background-size:cover;background-repeat:no-repeat;:hover{height:3.4em;width:3.4em;}@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]);
...
})(["border-radius:50%;grid-area:south-planet;height:3em;width:3em;position:relative;top:45px;cursor:pointer;background-image:url(\"../static/images/mars.png\");background-size:cover;background-repeat:no-repeat;:hover{height:3.4em;width:3.4em;}@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]);
...
})(["border-radius:50%;grid-area:west-planet;height:3em;width:3em;position:relative;right:45px;cursor:pointer;background-image:url(\"../static/images/jupiter.png\");background-size:cover;background-repeat:no-repeat;:hover{height:3.4em;width:3.4em;}@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]); // const Icon = styled.i`
...
//# sourceMappingURL=about.js.9eee7bdc6502839bc413.hot-update.js.map