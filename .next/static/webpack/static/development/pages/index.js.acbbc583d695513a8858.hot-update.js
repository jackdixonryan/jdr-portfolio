...
})(["width:80%;max-width:750px;margin:0 auto;background:white;border:2px teal solid;padding:20px;position:relative;top:-60px;border-radius:25px;h3{font-family:\"Poiret One\",sans-serif;text-align:center;}#grid{display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr;grid-template-areas:\"linkedin github email\";justify-items:center;align-items:center;.linkedin{grid-area:linkedin;}.github{grid-area:github;}.email{grid-area:email;}}"]);
function Contact() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Main, {
    ...
    href: "#",
    className: "contact animated fadeInLeft delay-2s github",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46
    },
    ...
    href: "#",
    className: "contact animated fadeInLeft delay-3s email",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50
    },
...
//# sourceMappingURL=index.js.acbbc583d695513a8858.hot-update.js.map