...
})(["width:80%;max-width:750px;margin:0 auto;background:white;border:2px teal solid;padding:20px;position:relative;top:-60px;border-radius:25px;h3{font-family:\"Poiret One\",sans-serif;text-align:center;}#grid{display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr;grid-template-areas:\"linkedin email github\";justify-items:center;align-items:center;.linkedin{grid-area:linkedin;}.github{grid-area:github;}.email{grid-area:email;}i{margin-right:6px;}a{font-size:1.5em;}}"]);
function Contact() {
...
//# sourceMappingURL=index.js.34c02f2990ce4c7ebd0a.hot-update.js.map