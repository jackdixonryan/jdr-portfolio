...
})(["background:white;border:2px teal solid;border-radius:50%;grid-area:sun;height:5em;width:5em;"]);
...
})(["border-radius:50%;grid-area:north-planet;height:3em;width:3em;position:relative;bottom:45px;cursor:pointer;@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]);
...
})(["border-radius:50%;grid-area:east-planet;height:3em;width:3em;position:relative;left:45px;cursor:pointer;@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]);
...
})(["border-radius:50%;grid-area:south-planet;height:3em;width:3em;position:relative;top:45px;cursor:pointer;@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]);
...
})(["border-radius:50%;grid-area:west-planet;height:3em;width:3em;position:relative;right:45px;cursor:pointer;@keyframes counter-rotate{0%{transform:rotate(0deg);}50%{transform:rotate(-179deg);}100%{transform:rotate(-359deg);}}animation-name:counter-rotate;animation-duration:120s;animation-iteration-count:infinite;"]); // const Icon = styled.i`
...
//# sourceMappingURL=about.js.8bb6df6eec674522043b.hot-update.js.map