...
})(["width:80%;max-width:750px;margin:0 auto;background:white;border:2px teal solid;padding:20px;position:relative;top:-60px;border-radius:25px;h3{text-align:center;font-family:\"Poiret One\",sans-serif;}.loc{text-align:center;}p{text-align:justify;}img{width:33%;margin:0 auto;border-radius:border:1px black solid;}"]);
function About() {
...
//# sourceMappingURL=index.js.9cdd2ab6cfdfde346f1f.hot-update.js.map